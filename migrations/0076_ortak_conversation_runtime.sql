-- Explicit conversation publication, frozen v4 input and current-use admission.
-- Additive after immutable75; retained source bytes never confer current authority.
