...
pub use work::{
    ...
    CompletionBlocker, CriterionStatus, NewProject, NewWorkItem, NewWorkItemIds, Project,
    ProjectEvent, ProjectSlug, ProjectStatus, WorkActor, WorkAttachment, WorkDependency, WorkEvent,
    WorkItem, WorkPriority, WorkState, MAX_WORK_APPROVALS, MAX_WORK_ASSIGNMENTS,
    MAX_WORK_ATTACHMENTS, MAX_WORK_CRITERIA, MAX_WORK_CRITERION_BYTES, MAX_WORK_DEPENDENCIES,
