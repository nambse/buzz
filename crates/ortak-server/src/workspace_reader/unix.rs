//! Unix descriptor ownership and containment implementation.
use super::{ReaderAction, ReaderRequest, ReaderResponse};
use ortak_control::workspace::WorkspaceResult;
